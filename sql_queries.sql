...
LEVEL_CLASS VARCHAR(15) NOT NULL,
GPA_REQ NUMERIC,
PRE_REQ_COURSES VARCHAR(50),
SPCL_APPROVAL_REQ VARCHAR(3) NOT NULL,
VARIABLE_CREDIT VARCHAR(10) NOT NULL,
...
SELECT * FROM ENROLLMENT ORDER BY CLASS_SIZE;
...
INSERT INTO COMP VALUES(to_timestamp('1994-01-01 12:30:00', 'YYYY-MM-DD HH:MI:SS'));
INSERT INTO COMP VALUES(to_timestamp('1994-01-01 12:45:00', 'YYYY-MM-DD HH:MI:SS'));
INSERT INTO COMP VALUES(to_timestamp('1994-01-01 12:50:00', 'YYYY-MM-DD HH:MI:SS'));
SELECT * FROM COMP ORDER BY TIME_STAMP;
SELECT * FROM COMP;
DROP TRIGGER CALCULATE_GPA_TRIGGER;

SELECT * FROM SPECIAL_PERMISSION WHERE APPROVAL_STATUS = 'Pending' ORDER BY CREATE_TIME;